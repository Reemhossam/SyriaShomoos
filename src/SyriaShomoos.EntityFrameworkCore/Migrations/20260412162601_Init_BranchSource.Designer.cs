...
namespace SyriaShomoos.Migrations
{
    ...
    [Migration("20260412162601_Init_BranchSource")]
    partial class Init_BranchSource
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SyriaShomoos.Entities.BranchSource", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("BranchSecretHash")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.ToTable("BranchSources");
                });

            modelBuilder.Entity("SyriaShomoos.Entities.Guest", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SyriaShomoos.Entities.GuestEscort", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SyriaShomoos.Entities.Reservation", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("SyriaShomoos.Entities.Guest", b =>
                {
                    b.HasOne("SyriaShomoos.Entities.Reservation", null)
                        .WithOne("MainGuest")
                        .HasForeignKey("SyriaShomoos.Entities.Guest", "ReservationId")
            ...
            modelBuilder.Entity("SyriaShomoos.Entities.Reservation", b =>
                {
                    b.HasOne("SyriaShomoos.Entities.BranchSource", "BranchSource")
                        .WithMany()
                        .HasForeignKey("BranchSourceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("BranchSource");
                });
