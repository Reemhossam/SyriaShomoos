...
public class SyriaShomoosDbContext :
    AbpDbContext<SyriaShomoosDbContext>,
    ...
    IIdentityDbContext
{
    ...
    public DbSet<GuestEscort> GuestEscorts { get; set; }
    public DbSet<BranchSource> BranchSources { get; set; }
